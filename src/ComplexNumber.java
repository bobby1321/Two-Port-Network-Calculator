 ...
 * <li>Complex Parsing of type x+jy</li>
 * </ul>
 * 
 * @author      Abdul Fatir
 * @version     1.1
...
public class ComplexNumber
{
    ...
    */
    ...
    {
        String re = String.format("%.3f ",this.real);
        String im = "";
        if(this.imaginary < 0)
            im = "- j"+String.format("%.3f",Math.abs(this.imaginary));
        else
            im = "+ j"+String.format("%.3f",this.imaginary);
        return re+im;
    }
    /**
